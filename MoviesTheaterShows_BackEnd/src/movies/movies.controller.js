...
async function movieExists(req, res, next){
    console.log("movies.controller::movieExists::::", req.params.movieId ,"\n:::", 
            typeof req.params.movieId,'\n');
    const movieId = Number(req.params.movieId);
    const movie = await movieService.read(Number(movieId));
    console.log("movies.controller::movieExists::::", movieId ,"\n type:::", typeof movieId
        ,'\n')
...
async function list(req, res){
    ...
    // console.log("list:::query::: ", query, ' whole ::', req.query);
